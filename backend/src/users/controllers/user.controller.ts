...
export async function create(req: Request, res: Response) {
    try {
        const newUser: Schema<IUser> = await UserModel.create(req.body);
...
export async function findAll(req: Request, res: Response) {
    try {
        const allUsers: Schema<IUser>[] = await UserModel.findAll();
...
export async function findOne(req: Request, res: Response) {
    try {
        const user: Schema<IUser> = await UserModel.findOne(req.params.id);
...
export async function update(req: Request, res: Response) {
    try {
        const updUser: Schema<IUser> = await UserModel.update(req.params.id, req.body);
